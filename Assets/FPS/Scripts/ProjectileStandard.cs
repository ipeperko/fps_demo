...
public class ProjectileStandard : MonoBehaviour
{
    ...
    void OnShoot()
    {
        ...
        //Debug.Log("colliders : " + ownerColliders);
    ...
    { 
        //Debug.Log("Projectile on hit - colider : " + collider);
        ...
        else
        {
            ...
            CarDamageable carDamageable = collider.GetComponent<CarDamageable>();
            if (carDamageable)
            {
                carDamageable.InflictDamage(damage, false, m_ProjectileBase.owner);
            }
        }
